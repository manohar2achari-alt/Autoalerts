...
#   - Microsoft.Graph.Users.Actions (for sending mail)
...
try {
    ...
    if ($alertItems.Count -gt 0) {
        ...
        foreach ($item in $alertItems) {
            $color = if ($item.DaysLeft -le 7) { "#ffcccc" } else { "#ffffff" }
        ...
        $htmlBody = @"
        <h3>Azure App Secret Expiry Alert</h3>
        <p>The following application secrets are approaching expiration:</p>
        <table border='1' cellpadding='8' style='border-collapse:collapse; border:1px solid #ddd; font-family:Arial, sans-serif;'>
            <tr style='background-color:#f2f2f2; text-align:left;'><th>App Name</th><th>App ID</th><th>Days Left</th><th>Expiry Date</th></tr>
            $tableRows
        </table>
        <p>Please rotate these secrets immediately to prevent production outages.</p>
        <p><em>Generated by Azure Automation</em></p>
"@

        $params = @{
            Message = @{
                Subject = "[ACTION REQUIRED] Azure Secrets Expiring"
                Body = @{
                    ContentType = "HTML"
                    Content = $htmlBody
                }
        ...
        # Requires Mail.Send permission on the Managed Identity
...
# 1. Read all App Registrations (to check dates)
# 2. Send emails as a user (to send alerts)
        ...
        <div className="space-y-16 mt-8 max-w-4xl mx-auto">
            ...
            <div className="flex gap-6">
                ...
                <div className="flex-grow">
                    ...
                    <p className="text-gray-600 mb-4">
                        ...
                        3. <strong>Important:</strong> Under the "Advanced" tab (or Identity tab), ensure <strong>System assigned managed identity</strong> is checked/enabled.<br/>
                        4. Review and Create.
                    </p>
                </div>
            </div>
            ...
            <div className="flex gap-6">
                ...
                <div className="flex-grow">
                    ...
                    <p className="text-gray-600 mb-4">
                        The script relies on the Microsoft Graph SDK. You must import these modules into your Automation Account:
                    </p>
                    ...
                    <ul className="list-disc list-inside text-gray-700 space-y-1 mb-4 font-mono text-sm">
                        <li>Microsoft.Graph.Authentication</li>
                        <li>Microsoft.Graph.Applications</li>
                        <li>Microsoft.Graph.Users.Actions (Required for sending mail)</li>
                    </ul>
                    <p className="text-sm text-gray-500">Note: Ensure you select Runtime version 5.1 (or 7.1/7.2 if available and compatible).</p>
                </div>
            </div>
            ...
            <div className="flex gap-6">
                ...
                <div className="flex-grow">
                    ...
                    <p className="text-gray-600 mb-4">
                        The Managed Identity creates a Service Principal in your tenant. You must grant it permission to read apps and send email. This <strong>cannot</strong> be done easily in the portal UI; you must run this PowerShell script locally once.
                    </p>
                    <CodeBlock 
                        language="powershell" 
             ...
             <div className="flex gap-6">
                ...
                <div className="flex-grow">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Create the Runbook</h3>
                    <p className="text-gray-600 mb-4">
                        1. Go to <strong>Runbooks</strong> → Create a runbook.<br/>
                        2. Name: <code>Monitor-AppSecrets</code>.<br/>
                        3. Type: <strong>PowerShell</strong>.<br/>
                        4. Paste the production script found in the "Scripts" section below.<br/>
                        5. Update the <code>$SenderMailbox</code> variable to a valid mailbox in your tenant (e.g., automation@domain.com).
                    </p>
                </div>
            </div>
            ...
            {/* Step 5 */}
             <div className="flex gap-6">
                ...
                <div className="flex-grow">
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Schedule It</h3>
                    <p className="text-gray-600 mb-4">
                        To catch the exact 60, 30, and 7-day marks, the script <strong>must run daily</strong>.
                    </p>
                    <ul className="list-disc list-inside text-gray-600 bg-gray-50 p-4 rounded-lg">
                ...
                <div className="flex">
                    ...
                    <div className="ml-3">
                        <p className="text-sm text-blue-700">
                            <strong>Requirement:</strong> The <code>$SenderMailbox</code> variable must be an actual mailbox (user or shared) that the Managed Identity has permission to send as.
                        </p>
                    </div>
                </div>
            </div>
